        ...
        <TabControl>
            <TabItem x:Name="tbUnlock" Header="Unlock and Information">
                <Grid Background="#FFE5E5E5">
                    ...
                    <CheckBox x:Name="chkLocked" Content="Locked" HorizontalAlignment="Left" Margin="233,230,0,0" VerticalAlignment="Top" IsEnabled="False" Grid.Column="3"/>
                    <CheckBox x:Name="chkEnabled" Content="Enabled" HorizontalAlignment="Left" Margin="337,230,0,0" VerticalAlignment="Top" Grid.Column="3"/>
                    <Button x:Name="btnUnlock" Content="Unlock" HorizontalAlignment="Left" Margin="285,265,0,0" VerticalAlignment="Top" Height="34" Width="52" Grid.Column="3"/>
                    <Label Content="Employee:" HorizontalAlignment="Left" Margin="230,88,0,0" VerticalAlignment="Top" Width="80" Height="26" Grid.Column="3"/>
                    <Label x:Name="lblEmpID" Content="" HorizontalAlignment="Left" Margin="385,88,0,0" VerticalAlignment="Top" Width="100" Height="26" Grid.Column="3"/>
                    <Label Content="Name:" HorizontalAlignment="Left" Margin="230,122,0,0" VerticalAlignment="Top" Width="80" Height="26" Grid.Column="3"/>
                    <Label x:Name="lblName" Content="" HorizontalAlignment="Left" Margin="385,122,0,0" VerticalAlignment="Top" Height="26" Grid.Column="3"/>
                    <Label Content="Username:" HorizontalAlignment="Left" Margin="230,153,0,0" VerticalAlignment="Top" Width="80" Height="26" Grid.Column="3"/>
                    <Label x:Name="lblUserName" Content="" HorizontalAlignment="Left" Margin="385,153,0,0" VerticalAlignment="Top" Width="100" Height="26" Grid.Column="3"/>
                    <Label Content="Job Title:" HorizontalAlignment="Left" Margin="230,184,0,0" VerticalAlignment="Top" Height="26" Grid.Column="3"/>
                    <Label x:Name="lblTitle" Content="" HorizontalAlignment="Left" Margin="385,184,0,0" VerticalAlignment="Top" Height="26" Grid.Column="3"/>
                    <Label x:Name="lblMessage" Content="" HorizontalAlignment="Left" Margin="1,291,0,0" VerticalAlignment="Top" Width="326" Height="95" FontFamily="Lucida Console" FontSize="16" Foreground="Black" Grid.ColumnSpan="3" Grid.Column="1"/>
                    <Label Content="- User Information -" HorizontalAlignment="Left" Margin="330,44,0,0" VerticalAlignment="Top" Width="134" Height="26" FontFamily="Arial" FontSize="14" Grid.Column="3"/>
                </Grid>
...
function LoadUSer{
    ...
    $var_lblEmpID.Content=$User.EmployeeID
...
function CreateUser {
    try {
        ...
        # Capture the OU value from the form input
        $ouInput = $var_tbOU.Text

        # Check if the OU input corresponds to a mapped value
        if ($ouMapping.ContainsKey($ouInput)) {
        # If it's a mapped value, use the full OU path from the dictionary
            $ouPath = $ouMapping[$ouInput]
        } else {
            # Otherwise, use the user input directly (assuming it's in the correct DN format)
            $ouPath = $ouInput
        }
